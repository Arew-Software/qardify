            ...
            <div
                ...
                <div class="md:w-1/2 mb-10 md:mb-0" @if (checkFrontLanguageSession() == 'ar') dir="rtl" @endif>
                    ...
                    <p class="text-lg text-secondary-600 leading-relaxed mb-8">
                        {{ $setting['sub_text'] ?? '' }}</p>
                    <div class="position-relative vcard-alias-search" style="border: 2px solid #dee2e6 !important; border-radius: 3px;">
                        <input id="search-alias-input" type="text"
                            class="form-control @if (checkFrontLanguageSession() == 'ar') text-left @endif"
                            placeholder="{{ __('messages.vcard.search_vcard_alias') }}" required>
                        <button id="search-alias-btn" type="submit"
                            class="ml-2 px-6 py-2.5 rounded-full text-white bg-gradient-to-r from-primary-500 to-accent-500 hover:from-primary-600 hover:to-accent-600 shadow-lg transition-all duration-300 hover:shadow-primary-900/30 hover:scale-105 font-medium top-50 end-0 me-2 @if (checkFrontLanguageSession() == 'ar') check-url-ar @endif">
                            {{ __('messages.vcard.check_availability') }}
                        </button>
                    </div>
                            ...
                            <div>
                                <div
                                    ...
                                    <div class="p-8">
                                        ...
                                        @else
                                            <div class="flex items-baseline mb-8" id="price_{{ $plan->id }}">
                                 ...
                                 class="fs-18 mb-3 text-gray-100">{{ __('messages.plan.custom_no_of_vcards') }}</label> --}}
                                        ...
                                        <ul class="space-y-4 mb-4">
                                            ...
                                            @if ($plan->custom_select == 0 && $plan->planCustomFields->isEmpty())
                                                <li class="active-check"
                                                    @if (checkFrontLanguageSession() == 'ar') style="text-align: right !important" @endif>
                                                    @if (checkFrontLanguageSession() == 'ar')
                                                        <span class="">{{ __('messages.plan.no_of_vcards') }}
                                            ...
                                            <li class="active-check"
                                                @if (checkFrontLanguageSession() == 'ar') style="text-align: right !important" @endif>
                                                @if (checkFrontLanguageSession() == 'ar')
                                                    <span class="">{{ __('messages.plan.storage_limit') }}:
                                            ...
                                            @php
                                                $skipCount =
                                                    $plan->custom_select == 0 && $plan->planCustomFields->isEmpty()
                                                        ? 9
                                                        : 10;
                                            @endphp
                                            @foreach (collect(getPlanFeature($plan))->take($skipCount) as $feature => $value)
                                                <li class="{{ $value == 1 ? 'active-check' : 'unactive-check' }}"
                                                    ...
                                                    @if (checkFrontLanguageSession() == 'ar')
                                                        ...
                                                        <i
                                                            class='bx text-xl {{ $value == 1 ? 'text-primary-500 bx-check-circle' : 'text-secondary-400 bx-x-circle' }} @if (checkFrontLanguageSession() == 'ar') ml-2 @else mr-2 @endif mt-0.5'></i>
                                                    @else
                                                        <i
                                                            class='bx text-xl {{ $value == 1 ? 'text-primary-500 bx-check-circle' : 'text-secondary-400 bx-x-circle' }} @if (checkFrontLanguageSession() == 'ar') ml-2 @else mr-2 @endif mt-0.5'></i>
                                                        <span>{{ __('messages.feature.' . $feature) }}</span>
                                        ...
                                        <div class="mb-8 border-t border-gray-100 pt-3">
                                            <button
                                                ...
                                                <i
                                                    class='bx bx-chevron-down text-lg transition-transform duration-200'></i>
                                            </button>
