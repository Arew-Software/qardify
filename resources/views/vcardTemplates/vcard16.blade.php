...
<body>
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden  @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-30 py-4 position-relative">
                <div class="position-absolute top-0 start-0 w-100 h-100 main-vector-bg">
                    <img src="{{ asset('assets/img/vcard16/main-vector-bg.png') }}" alt="images" class="w-100 h-100 object-fit-cover" />
                    </div>
                <div class="row justify-content-end">
                    <div class="col-12">
                        <div class="card flex-sm-row gap-3 align-items-center @if ($vcard->cover_type == 2) profile-margin @endif">
                            ...
                            <div class="card-body text-sm-start text-center p-0">
                                <div class="profile-name">
                                    ...
                                    <p class="fs-16 text-primary fw-5 mb-1">{{ ucwords($vcard->company) }}</p>
                ...
                <div class="social-media mt-0 pt-40 d-flex justify-content-center">
            ...
            <div class="px-30 pt-3 position-relative">
            ...
            <div class="custom-link-section">
                @if (checkFeature('custom-links'))
                    <div class="custom-link d-flex flex-wrap justify-content-center pt-40 w-100 position-relative">
...
@if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
    <div class="contact-section pt-40 pb-30 position-relative">
...
@endif
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50  pb-50 bg-primary position-relative">
                        <div class="position-absolute vector-3 vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-3.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="bg-vector-1 position-absolute vector-all">
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-40 position-relative">
                    <div class="position-absolute vector-4 vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-4.png') }}" alt="images" class="w-75" />
                        </div>
                    <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['services']) || empty($managesection))
                @if (checkFeature('services') && $vcard->services->count())
                    <div class="our-services-section pt-40">
                        ...
                        <div class="services px-30 pb-40">
            ...
            @if ((isset($managesection) && $managesection['galleries']) || empty($managesection))
                @if (checkFeature('gallery') && $vcard->gallery->count())
                    <div class="gallery-section px-30 bg-primary position-relative pt-40 pb-40">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-40 pb-40 position-relative">
                        <div class="position-absolute vector-5 vector-all">
                            <img src="{{ asset('assets/img/vcard16/vector-5.png') }}" alt="images" class="w-100" />
                        </div>
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['testimonials']) || empty($managesection))
                @if (checkFeature('testimonials') && $vcard->testimonials->count())
                    <div class="testimonial-section pt-40 pb-40 bg-primary position-relative">
                        <div class="section-heading text-center mb-40">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-section pt-40 position-relative">
                        <div class="position-absolute vector-6 vector-all @if (getLanguage($vcard->default_language) == 'Arabic') text-end @else text-start @endif">
                        ...
                        <nav>
                            <div class="row insta-toggle mx-0">
                                <div class="nav nav-tabs border-0 px-3" id="nav-tab" role="tablist">
                                    <button
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-40 pb-40">
                        ...
                        <div class="blog-bg vector-all text-end">
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="business-hour-section pt-40 pb-50 bg-primary position-relative">
                        ...
                        <div class="business-hour-bg @if (getLanguage($vcard->default_language) == 'Arabic') text-end @endif">
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-40 pb-40 position-relative">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->enquiry_form && $vcard->enable_enquiry_form)
                <div class="contact-us-section pb-40 px-30 position-relative">
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section bg-primary pt-40 pb-40 position-relative">
                    <div class="position-absolute vector-10 vector-all text-end">
                            <img src="{{ asset('assets/img/vcard16/vector-9.png') }}" alt="images" class="w-75" />
                        </div>
                        <div class="bg-vector-2 position-absolute vector-all">
            ...
            @endif
            {{-- made_by --}}
            <div class="d-flex justify-content-evenly pt-40">
