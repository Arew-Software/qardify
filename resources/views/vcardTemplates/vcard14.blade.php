...
<body>
    ...
    <div class="container p-0">
        ...
        <div
            ...
            <div class="our-services-section main-section pt-30 pb-30  px-20 position-relative">
                ...
                <div class="services">
                    ...
                    <div class="services-slider-view pb-2">
                    ...
                    <div class="row row-gap-15px">
                        @foreach ($vcard->services as $service)
                        <div class="col-sm-6">
                            <div class="service-card d-flex flex-column gap-3" @if (getLanguage($vcard->
            ...
            <div class="w-100 d-flex justify-content-center sticky-vcard-div">
                ...
                <div class="" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    @if ($contactRequest == 1)
                    <a href="{{ Auth::check() ? route('add-contact', $vcard->id) : 'javascript:void(0);' }}" class="btn add-contact-btn d-flex justify-content-center ms-0 align-items-center  text-decoration-none justify-content-center
