                        ...
                        <div>
                            <div class="service-card h-100">
                                ...
                                <div class="card-body text-center">
                                    ...
                                    <p
                                        class="mb-0 fs-16 text-gray description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 mb-4">
                            <div class="service-card h-100">
                                ...
                                <div class="card-body text-center">
                                    <h3 class="card-title fs-18 fw-bold text-black">
                                        {{ ucwords($service->name) }}
                                    </h3>
                                    <p
                                        class="mb-0 fs-16 text-gray description-text {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                    ...
                    <div class="">
                        <div class="blog-card" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            ...
                            <div class="card-body text-sm-start text-center">
                                ...
                                <p class="text-gray blog-desc mb-0">
