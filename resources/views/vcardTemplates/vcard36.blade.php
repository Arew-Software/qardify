...
<body>
    <div class="container p-0">
        ...
        @endif
        <div class="main-content mx-auto w-100 position-relative overflow-hidden bg-white @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-30 @if ($vcard->cover_type == 2) mt-3 @endif"
                ...
                <div class="card mb-30 d-flex flex-sm-row align-items-center border-0">
                ...
                <div class="text-gray-200 fs-14 text-center" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    <p class="text-gray-200 profile-desc mb-0">
                        {!! $vcard->description !!}
                    </p>
                </div>
        {{-- social-media --}}
            ...
            @if ((isset($managesection) && $managesection['contact_list']) || empty($managesection))
                @if(!empty($vcard->email) || !empty($vcard->alternative_email || !empty($vcard->phone) || !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
                    <div class="contact-section pt-60 px-30" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="row">
                            <div class="col-sm-6  mb-sm-0 mb-30 d-flex align-items-center">
                            ...
                            <div class="row services-slider-view">
                                <div class="service-slider ">
                                    @foreach ($vcard->services as $service)
                                        <div>
                                            <div class="service-card d-flex align-items-center justify-content-center flex-column gap-2">
                                                <div class="card-img">
                          ...
                          <div class="px-30">
                            <div class="row services-grid-view">
                                <div class="col-12 mb-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                    @foreach ($vcard->services as $service)
                                        <div class="service-card card d-flex flex-column flex-sm-row align-items-center mb-4">
                                            <div class="card-img">
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    class="{{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                    target="{{ $service->service_url ? '_blank' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    <div class="product-section pt-60 px-30">
                                        ...
                                        <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                            ...
                                            <div class="product-desc card-body">
                                                <div class="d-flex align-items-center justify-content-center flex-column gap-2">
                                                    ...
                                                    <p class="amount fs-6 mb-0 fw-5 text-end">
                                                        @if ($product->currency_id && $product->price)
                                                            <span
                                                                class="fs-18 fw-5 text-primary">{{ $product->currency->currency_icon }}{{ number_format($product->price, 2) }}</span>
                                                        @elseif($product->price)
                                                            <span
                                                                class="fs-18 fw-5 text-primary">{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price }}</span>
                                                        @endif
                                                    </p>
                                                </div>
                                            </div>
                     ...
                     <div class="text-center">
                        <div class="mt-5 text-center view-more d-inline-flex gap-2 align-items-center">
                            <a class="text-primary fs-6 text"
                                ...
                                <div>
                                    <div class="testimonial-card card">
                                        <div class="quote-img quote-left">
                                            <img src="{{ asset('assets/img/vcard36/quote-left.svg') }}"
                                                alt="quote" />
                                        </div>
                                        <div class="quote-img quote-right">
                                            <img src="{{ asset('assets/img/vcard36/quote-right.svg') }}"
                                                alt="quote" />
                                        </div>
                                        <div class="card-body p-0">
                                            <p
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-60">
                        ...
                        <div
                            class="blog-slider pb-0 px-30 @if (getLanguage($vcard->default_language) == 'Arabic') blog-rtl @endif">
                                    ...
                                    <div class="blog-card d-flex flex-column align-items-center"
                                        ...
                                        <div class="card-body text-sm-start text-center">
                                            <a href="{{ $vcardBlogUrl }}">
                                                ...
                                                <p class="text-gray-200 blog-desc fs-14 mb-0">
                ...
                @if ($vcard->businessHours->count())
                    ...
                    <div class="business-hour-section pt-60 px-30"
                        ...
                        <div class="business-hour-heading section-heading right-heading"
                            @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                            <h2 class="mb-0 text-white">{{ __('messages.business.business_hours') }}</h2>
                        </div>
                                    ...
                                    <div class="col-sm-6 mb-3 pe-sm-2">
                                        <div class="business-hour align-items-center">
                                            <div class="time-icons d-flex align-items-center justify-content-center">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-calendar-time text-gray-200" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                            ...
                                            <div class="business-details d-flex flex-column gap-1">
                                                <span
            ...
            @if (isset($vcard['show_qr_code']) && $vcard['show_qr_code'] == 1)
                <div class="qr-code-section pt-60" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                    ...
                    <div class="qr-code mx-auto position-relative pt-40 pb-40 px-30">
                        <div class="overlay"></div>
                        <div class="qr-code-img mx-auto position-relative d-flex align-items-center justify-content-center"
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="blog-section pt-40 mb-3 px-30">
                        <div class="section-heading left-heading px-30"
                            @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                        ...
                                        <div class="col-12 mb-4 mt-2">
                                            ...
                                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                                ...
                                                <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                                                    target="_blank"
                                                    class="text-decoration-none link-info fs-6 text-primary">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                <span class="text-gray">&</span>
                                                <a href="{{ route('vcard.show-privacy-policy', [$vcard->url_alias, $vcard->id]) }}"
                                                    target="_blank"
                                                    class="text-decoration-none link-info fs-6 text-primary">{{ __('messages.vcard.privacy_policy') }}</a>
                                            </label>
                                        </div>
                                    @endif
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-60 px-30 pb-60" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
