    ...
    <div class="container p-0">
        ...
        <div class="main-content mx-auto w-100 overflow-hidden bg-green @if (getLanguage($vcard->default_language) == 'Arabic') rtl @endif">
            ...
            <div class="profile-section px-40 @if($vcard->cover_type == 2) profile-margin @endif">
                ...
                @endif
                <div class="text-gray-100 profile-desc mb-30 fs-14 text-center">
                    {!! $vcard->description !!}
                </div>
            </div>
            {{-- social icons --}}
            ...
            @if ((isset($managesection) && $managesection['products']) || empty($managesection))
                @if (checkFeature('products') && $vcard->products->count())
                    ...
                    <div class="text-center">
                        <div class="me-5 text-center view-more d-inline-flex gap-2 align-items-center">
                            <a class="fs-6 text text-white"
                                href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}</a>
                                <i class="fa-solid fa-arrow-right text-white right-arrow-animation"></i>
                        </div>
                        </div>
                    </div>
                @endif
