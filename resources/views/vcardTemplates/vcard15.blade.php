...
<body>
    <div class="container p-0">
        ...
        <div
            ...
            {{-- profile --}}
            <div class="">
                <div class="profile-section px-30 position-relative pb-50">
                    <div class="position-absolute bg-vector bg-vector1 text-end">
                        <img src="{{ asset('assets/img/vcard15/bg-vector1.png') }}" alt="images" />
                    </div>
                    <div class="position-absolute bg-vector bg-vector2">
                        <img src="{{ asset('assets/img/vcard15/bg-vector2.png') }}" alt="images" />
                    </div>
                    <div class="card text-start">
                        ...
                        <div class="card-body text-start px-0 pb-0">
                            <div class="profile-name text-center">
                                <h2 class="font-cormorant vcard-profile-name mt-2 mb-1">
                                ...
                                <p class="fs-14 mb-20 text-gray-300">{{ ucwords($vcard->job_title) }}</p>
                                <div class="fs-14 text-center">
                                    <div class="text-primary mb-0 text-center fs-14">
                                        {!! $vcard->description !!}
                                    </div>
                                </div>
                            </div>
                    ...
                    @if (checkFeature('social_links') && getSocialLink($vcard))
                        <div class="social-media  d-flex  flex-wrap justify-content-center mb-40">
                            <div class="social-icons d-flex justify-content-center align-items-center pt-3 flex-wrap">
            ...
            @if (((isset($managesection) && $managesection['contact_list']) || empty($managesection)) && $hasContactData)
                <div class="contact-section pb-50 pb-3 position-relative">
                    <div class="position-absolute bg-vector bg-vector3">
                        <img src="{{ asset('assets/img/vcard15/bg-vector3.png') }}" alt="images" />
                    </div>
                    <div class="section-primary position-relative text-center border-top-0">
                        <h2 class="font-cormorant text-primary mb-0 d-inline-block bg-white">
                                ...
                                @if ($vcard->dob)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="mb-0 text-primary">{{ $vcard->dob }}
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                @if ($vcard->location)
                                    <div class="col-sm-6 mb-4">
                                        <div class="contact-box d-flex align-items-center">
                                            ...
                                            <div class="contact-desc">
                                                <p class="text-primary mb-0 fs-12">{!! ucwords($vcard->location) !!}</p>
                                            </div>
                                        </div>
                                    </div>
                                @endif
            ...
            <div class="our-services-section bg-gray pt-30  position-relative">
                <div class="position-absolute bg-vector bg-vector4 text-end">
                        <img src="{{ asset('assets/img/vcard15/bg-vector4.png') }}" alt="images" class="w-100" />
                    </div>
                <div class="section-primary position-relative d-flex justify-content-center align-items-center mb-3">
                    <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">
                        {{ __('messages.vcard.our_service') }}
                    </h2>
                </div>
                <div class="services pt-3 mt-3 px-30 pb-30">
                        ...
                        <div>
                            <div class="card-wrapper h-100">
                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                    class="text-decoration-none" target="{{ $service->service_url ? '_blank' : '' }}">
                                    <div class="service-card card h-100">
                                        <div class="card-img mb-3 mx-auto">
                                ...
                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                    ...
                                    <div class="service-card card h-100">
                                        ...
                                        <div class="card-body p-0 text-center">
                                            ...
                                            <p
                                                class="mb-0 text-primary-light {{ \Illuminate\Support\Str::length($service->description) > 170 ? 'more' : '' }}">
                                                {!! \Illuminate\Support\Str::limit($service->description, 170, '...')
                                                !!}
                                            </p>
                                        </div>
            ...
            <div class="qr-code-section pt-50 pb-50 position-relative">
                ...
                <div class="px-30">
                    <div class="qr-box d-flex gap-4 align-items-center flex-wrap flex-sm-nowrap justify-content-center"  @if (getLanguage($vcard->default_language) == 'Arabic')
                        dir="rtl" @endif>
            ...
            <div class="gallery-section pt-50 pb-40 position-relative">
                <div class="position-absolute bg-vector bg-vector5 text-end">
                    <img src="{{ asset('assets/img/vcard15/bg-vector5.png') }}" alt="images" class="w-100" />
                </div>
                <div class="position-absolute bg-vector bg-vector6">
                    <img src="{{ asset('assets/img/vcard15/bg-vector6.png') }}" alt="images" />
                </div>
                <div class="section-primary position-relative d-flex justify-content-center align-items-center mb-3">
            ...
            <div class="product-section bg-gray pb-50 position-relative">
                <div class="position-absolute bg-vector bg-vector7">
                        <img src="{{ asset('assets/img/vcard15/bg-vector7.png') }}" alt="images" />
                    </div>
                <div class="section-primary position-relative d-flex justify-content-center align-items-center mb-3">
                    <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block">{{
                ...
                <div class="px-30">
                                    ...
                                    <div class="product-card card">
                                        ...
                                        <div class="product-desc card-body text-center">
                                            ...
                                            <div class="product-amount">
                                                ...
                                                <span>{{ getUserCurrencyIcon($vcard->user->id) . ' ' . $product->price
                                                    }}</span>
                                                @endif
                                            </div>
                                        </div>
                    ...
                    <div class="mt-4 mx-auto d-flex justify-content-center">
                        <a class="view-more-btn fs-6 text-white text-decoration-underline fw-4 py-2 ps-3 pe-4 d-inline-flex justify-content-center align-items-center gap-2 position-relative z-2"
                            href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}
                            <i class="fa-solid fa-arrow-right-long right-arrow-animation text-white"></i></a>
                    </div>
                </div>
            </div>
            @endif
            ...
            <div class="testimonial-section pt-50 pb-50">
                ...
                <div class="px-30">
                    <div class="testimonial-slider">
                        ...
                        <div class="px-1">
                            <div class="testimonial-card" @if (getLanguage($vcard->default_language) == 'Arabic')
                                dir="rtl" @endif>
                                ...
                                <div class="card-body text-center position-relative">
                                    ...
                                    <div class="text-center">
                                        <p
                                            class="text-primary {{ \Illuminate\Support\Str::length($testimonial->description) > 80 ? 'more' : '' }}">
            ...
            @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
                @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                    <div class="insta-feed-section pt-50 bg-gray position-relative">
                        <div class="position-absolute bg-vector bg-vector8 text-end">
                            <img src="{{ asset('assets/img/vcard15/bg-vector8.png') }}" alt="images" class="w-100" />
                        </div>
                        <div
                            class="text-center mb-3 section-primary position-relative d-flex align-items-center justify-content-center">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-gray">
                        ...
                        <div id="postContent" class="insta-feed">
                            <div class="row overflow-hidden m-0 mt-2 px-3 row-gap-20px" loading="lazy">
                                <!-- "Post" content -->
                        ...
                        <div class="d-none insta-feed" id="reelContent">
                            <div class="row overflow-hidden m-0 mt-2 row-gap-20px">
                                <!-- "Reel" content -->
                                @foreach ($vcard->InstagramEmbed as $InstagramEmbed)
            ...
            @if ((isset($managesection) && $managesection['blogs']) || empty($managesection))
                @if (checkFeature('blog') && $vcard->blogs->count())
                    <div class="blog-section pt-50 position-relative">
                        <div class="position-absolute bg-vector bg-vector9">
                            <img src="{{ asset('assets/img/vcard15/bg-vector9.png') }}" alt="images" />
                        </div>
                        <div
                            ...
                            <div class="card-wrapper">
                                <a href="{{ $vcardBlogUrl  }}">
                                    <div class="blog-card card">
                                        ...
                                        <div class="card-body d-flex flex-column justify-content-between text-start px-0 pb-0">
                                            <h5 class="text-dark fs-20 mb-2"> {{ $blog->title }}</h5>
                                            <div class="text-gray-100 mb-0 blog-desc flex-1">
                                                {!! $blog->description !!}
                                            </div>
            ...
            @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
                @if ($vcard->businessHours->count())
                    ...
                    @endphp
                    <div class="bussiness-hour-section overflow-hidden bg-gray pt-50 pb-40 position-relative">
                        <div class="position-absolute bg-vector bg-vector10 text-end">
                            <img src="{{ asset('assets/img/vcard15/bg-vector10.png') }}" alt="images" />
                        </div>
                        <div class="position-absolute bg-vector bg-vector11">
                            <img src="{{ asset('assets/img/vcard15/bg-vector11.png') }}" alt="images" />
                        </div>
                        <div
                                ...
                                @foreach ($businessDaysTime as $key => $dayTime)
                                    <div class="col-sm-6">
                                        <div
                                            ...
                                            <div class="fs-14 fw-medium text-white">
                                                {{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ':' }}
                                            </div>
                                            <div
                                                class="text-white fs-14 fw-semibold time d-flex gap-2 align-items-center">
                                                <div class="time-icon">
                                                    <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg"
                                                        ...
                                                        <defs>
                                                            <linearGradient id="clockGradient" x1="0%"
                                                                y1="0%" x2="100%" y2="0%">
                                                                <stop offset="0%" stop-color="#0c3636" />
                                                                <stop offset="50%" stop-color="#52796f" />
                                                                <stop offset="100%" stop-color="#0c3636" />
                                                            </linearGradient>
                                                        </defs>
            ...
            @if ((isset($managesection) && $managesection['appointments']) || empty($managesection))
                @if (checkFeature('appointments') && $vcard->appointmentHours->count())
                    <div class="appointment-section pt-50 pb-40 position-relative">
                                ...
                                <div class="col-sm-12">
                                    <div class="row">
                                        <div class="col-12 mb-20">
                                            {{ Form::text('date', null, [
                                                'class' => 'form-control appointment-input date
                                                                                                                        appoint-input text-start',
            ...
            @if ((isset($managesection) && $managesection['iframe']) || empty($managesection))
                @if (checkFeature('iframes') && $vcard->iframes->count())
                    <div class="iframe-section pt-50 position-relative overflow-hidden">
                        <div class="position-absolute bg-vector bg-vector12 text-end">
                            <img src="{{ asset('assets/img/vcard15/bg-vector12.png') }}" alt="images" class="w-100" />
                        </div>
                        <div
                            class="position-relative d-flex section-primary justify-content-center align-items-center mb-4">
                            <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
            ...
            @php
                $currentSubs = $vcard
                    ...
                    ->first();
            @endphp
            <div class="contact-us-section bg-gray pt-50 position-relative">
                <div class="position-absolute bg-vector bg-vector13">
                    <img src="{{ asset('assets/img/vcard15/bg-vector13.png') }}" alt="images" />
                </div>
                                            ...
                                            <div class="col-12 mt-1">
                                                ...
                                                <label class="form-check-label fs-14" for="privacyPolicyCheckbox">
                                                    ...
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-underline link-info fw-5">{!! __('messages.vcard.term_and_condition') !!}</a>
                                                    <span class="text-dark">&</span>
                                                    <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                                        class="text-decoration-underline link-info fw-5">{{ __('messages.vcard.privacy_policy') }}</a>
                                                </label>
                                            </div>
                                        @endif
            ...
            @if ($currentSubs && $currentSubs->plan->planFeature->affiliation && $vcard->enable_affiliation)
                <div class="create-vcard-section pt-50 position-relative bg-white">
                    <div class="position-absolute bg-vector bg-vector14 text-end">
                        <img src="{{ asset('assets/img/vcard15/bg-vector14.png') }}" alt="images" />
                    </div>
                    <div
                        class="section-primary d-flex justify-content-center align-items-center position-relative mb-40">
                        <h2 class="font-cormorant text-primary text-center mb-0 d-inline-block bg-white">
            ...
            {{-- map --}}
                    ...
                    <div class="main-section px-30 pt-30">
