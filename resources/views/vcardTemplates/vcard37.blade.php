...
<body>
    ...
    @endif
    <div class="main-section position-relative m-auto overflow-hidden">
        ...
        <div class="introduction-section px-30px position-relative mb-20px @if ($vcard->cover_type == 2) main-banner-video @endif"
           ...
           {{--  <div class="position-absolute vector-75 hero-vector-1 text-end">
            ...
            <div
                class="d-block d-sm-flex gap-30 @if ($vcard->cover_type == 2) profile-margin align-items-center @else align-items-start @endif">
                ...
                <div class="@if ($vcard->cover_type == 2) pt-1 text-center text-sm-start @else pt-sm-5 text-center text-sm-start @endif ">
                    <p
                        class="@if ($vcard->cover_type == 2) pt-2 @else pt-sm-5 @endif fw-semibold text-teal-green fs-26 mb-1 text-center text-sm-start lh-12 @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @endif">
                        {{ ucwords($vcard->first_name . ' ' . $vcard->last_name) }} {{-- @if ($vcard->is_verified) --}}
                        <i class="verification-icon bi-patch-check-fill"></i>
                        {{-- @endif --}}
                    </p>
                    <p
                        class="text-black fs-16 fw-semibold mb-2 company-name position-relative pb-1 text-center text-sm-start lh-12 @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @endif">
                        {{ ucwords($vcard->company) }}</p>
                    <p
                        class="text-gray fs-14 fw-semibold vcard-name text-center text-sm-start lh-12 @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @endif">
        ...
        <div class="fs-14 fw-medium text-gray-300 mb-0 text-center px-30px pb-3" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                <p class="fs-14 fw-medium text-gray mb-0 text-center">{!! $vcard->description !!}</p>
            </div>
        <!-- social-section -->
        <div class="social-section px-30px pb-3">
            @if (checkFeature('social_links') && getSocialLinkIcon($vcard))
                <div class="d-flex gap-16 flex-wrap justify-content-center align-items-center mb-20px">
        ...
        @if(!empty($vcard->email) || !empty($vcard->alternative_email || !empty($vcard->phone) || !empty($vcard->alternative_phone) || !empty($vcard->dob) || !empty($vcard->location)))
            <div class="personal-details bg-white position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                ...
                <div class="row position-relative row-gap-10px">
                    @if ($vcard->email)
                        <div class="col-sm-6">
                            <a href="mailto:{{ $vcard->email }}" class="text-decoration-none contact-box">
                                <div class="box-1 d-flex">
                                    ...
                                    <div class="box1-content fs-14 fw-medium lh-base text-black text-break">
                                        {{ $vcard->email }}
                                    </div>
                                </div>
                            </a>
                        ...
                        <div class="col-sm-6">
                            <a href="tel:+{{ $vcard->region_code }}{{ $vcard->phone }}" class="text-decoration-none">
                                <div class="box-1 d-flex">
                                    ...
                                    <div class="box1-content fs-14 fw-medium lh-base text-black">
                        ...
                        @else
                            <div class="row services-grid-view px-4">
                                <div class="col-12 mb-4" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                    @foreach ($vcard->services as $service)
                                        <div class="service-card card d-flex flex-column flex-sm-row justify-content-center gap-2 gap-sm-3 align-items-center mb-4">
                                            <div class="card-img">
                                                <a href="{{ $service->service_url ?? 'javascript:void(0)' }}"
                                                    class="{{ $service->service_url ? 'pe-auto' : 'pe-none' }}"
                                                    target="{{ $service->service_url ? '_blank' : '' }}">
                    ...
                    <div class="appointment-section" @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                        ...
                        <div class="appointment-bg position-relative appointment">
                            ...
                            <div class="position-relative">
                                <div
                                    class="input-group-date d-flex align-items-center position-relative mb-20px">
        ...
        @if ((isset($managesection) && $managesection['products']) || empty($managesection))
            @if (checkFeature('products') && $vcard->products->count())
                                ...
                                <div class="product-box w-100 mx-auto">
                                    <a @if ($product->product_url) href="{{ $product->product_url }}" @endif
                                        ...
                                        <div class="product-content"
                                            @if (getLanguage($vcard->default_language) == 'Arabic') dir="rtl" @endif>
                                            <div class="d-flex align-items-start gap-2 justify-content-center mb-2 flex-column">
                ...
                <div class="text-center">
                    <div class="mt-5 text-center view-more mb-0 d-inline-flex gap-2 align-items-center">
                        <a class="fs-6 text product-view-more text-teal-green"
                            href="{{ $vcardProductUrl }}">{{ __('messages.analytics.view_more') }}</a>
                            <i class="fa-solid fa-arrow-right right-arrow-animation text-teal-green"></i>
                    </div>
                    </div>
                </div>
            @endif
                        ...
                        @foreach ($vcard->testimonials as $testimonial)
                            <div>
                                <div class="testimonial-box bg-white">
                                    <div
                                        class="d-block d-sm-flex gap-1 align-items-center @if (getLanguage($vcard->default_language) == 'Arabic') flex-row-reverse @endif">
                                        <div
                                        ...
                                        <div class="ms-2">
                                            ...
                                            <p
                                                class="fs-18 fw-semibold mb-0 text-black-100 lh-12 text-center text-sm-start testimonial-title @if (getLanguage($vcard->default_language) == 'Arabic') text-sm-end @endif">
        ...
        @if ((isset($managesection) && $managesection['insta_embed']) || empty($managesection))
            @if (checkFeature('insta_embed') && $vcard->instagramEmbed->count())
                <div class="">
                    <div class="section-heading text-center mb-30px px-30px mt-5 mb-3">
                        <p
                            class="text-black text-center fs-26 fw-bold d-inline-block position-relative mb-0 lh-normal">
        ...
        @if ((isset($managesection) && $managesection['business_hours']) || empty($managesection))
            @if ($vcard->businessHours->count())
                ...
                <div class="business-section px-30px pt-60px position-relative"
                    ...
                    <div class="business-box row row-gap-20px">
                        @foreach ($businessDaysTime as $key => $dayTime)
                            <div class="col-sm-6">
                              <div class="business-box1 d-flex align-items-center gap-3">
                                ...
                                <div class="business-hour">
                                    <div
                                        class="fs-14 fw-semibold text-black">{{ __('messages.business.' . \App\Models\BusinessHour::DAY_OF_WEEK[$key]) . ' ' }}:</div>
                                    <div
                                        class="fs-14 fw-semibold text-black">{{ $dayTime ?? __('messages.common.closed') }}</div>
                                </div>
                                </div>
                            </div>
                        @endforeach
            ...
            <div class="qr-section pt-60px position-relative">
                ...
                <div class="qr-bg">
                    <div
                        ...
                        <div class="qr-img mx-auto h-100 w-100" id="qr-code-thirtyseven">
            ...
            <div class="contact-us-section px-30px pt-60px position-relative"
               ...
               <div class="contact-form">
                <form action="" id="enquiryForm" enctype="multipart/form-data">
                    ...
                    <div class="mb-15px">
                        <input type="text" class="form-control text-gray fs-16 fw-semibold"
                            name="name" placeholder="{{ __('messages.form.your_name') }}" />
                    </div>
                    <div class="mb-15px">
                        <input type="email" class="form-control text-gray fs-16 fw-semibold"
                            name="email" placeholder="{{ __('messages.form.your_email') }}" />
                    </div>
                    <div class="mb-15px">
                        <input type="tel"
                            class="form-control text-gray fs-16 fw-semibold  @if (getLanguage($vcard->deault_language) == 'Arabic') text-end @endif"
                            name="phone" placeholder="{{ __('messages.form.phone') }}"
                            onkeyup="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,&quot;&quot;)" />
                    </div>
                    <div class="mb-15px">
                        <textarea class="form-control text-gray fs-16 fw-semibold" name="message"
                        ...
                        <div class="col-12 mb-4">
                            ...
                            <label class="form-check-label" for="privacyPolicyCheckbox">
                                ...
                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                    class="text-decoration-none link-info fs-6 text-teal-green">{!! __('messages.vcard.term_and_condition') !!}</a>
                                <span class="text-black">&</span>
                                <a href="{{ $vcardPrivacyAndTerm }}" target="_blank"
                                    class="text-decoration-none link-info fs-6 text-teal-green">{{ __('messages.vcard.privacy_policy') }}</a>
                            </label>
                        </div>
                    @endif
                    <div class="text-center">
            ...
            <div class="z-1 your-vcard-section px-30px pt-60px position-relative mb-4">
                ...
                <div class="your-vacrd-bg position-relative" @if (getLanguage($vcard->default_language) == 'Arabic') dir='rtl' @endif>
                    <div
                        ...
                        <a class="text-black fs-14 lh-base text-wrap fw-semibold text-decoration-none"
